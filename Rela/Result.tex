...
The test are done taking in account the following parameters: A contains \numprint{16000000} elements, k is set to 25 and the parallel degree is 8. The below table show the result obtained by the test.
